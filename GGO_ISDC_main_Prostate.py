...
#### Attempt: Testing and Traning GGO-ISDC main function on the Prostate dataset
'''
Paper Title:
...
if __name__ == '__main__':
    ...
    paras.add_argument('--class_num', type=int, default=3)  #Prostate: 3
    ...
    paras.add_argument('--feats_save_path', type=str,
                       default=r'/root/autodl-tmp/GGO_ISDC_public/Results/Features/Prostate/GGO_ISDC')
    paras.add_argument('--layers_save_path', type=str,
                       default=r'/root/autodl-tmp/GGO_ISDC_public/Results/Layers/Prostate/GGO_ISDC')
    paras.add_argument('--relations_save_path', type=str,
                       default=r'/root/autodl-tmp/GGO_ISDC_public/Results/Relations/Prostate/GGO_ISDC')

    paras.add_argument('--roc_save_path', type=str,
                       default=r'/root/autodl-tmp/GGO_ISDC_public/Results/Predictions/Prostate')
    paras.add_argument('--roc_name', type=str, default=r'ROC_GGO_ISDC.csv')
    paras.add_argument('--train_log_path', type=str,
                       default=r'/root/autodl-tmp/GGO_ISDC_public/Results/Our_wegts/Prostate/GGO_ISDC_Prostate_train_log.txt')

    # read datasets
    paras.add_argument('--train_read_path', type=str,
                default=r'/root/autodl-tmp/GGO_ISDC_public/Datasets/Prostate/Prostate_WSI_without_PE/Train')
    paras.add_argument('--test_read_path', type=str,
                default=r'/root/autodl-tmp/GGO_ISDC_public/Datasets/Prostate/Prostate_WSI_without_PE/Test')
    paras.add_argument('--val_read_path', type=str,
                default=r'/root/autodl-tmp/GGO_ISDC_public/Datasets/Prostate/Prostate_WSI_without_PE/Test')

    paras.add_argument('--weights_save_path', type=str,
        default=r'/mnt/Weights_Result_Text/GGO_ISDC/Prostate/GGO_ISDC_Prostate.pth')
    paras.add_argument('--test_weights_path', type=str,
            default=r'/root/autodl-tmp/Weights_Result_Text/GGO_ISDC/Prostate/GGO_ISDC_Prostate.pth')


    ### Parallel save
    paras.add_argument('--weights_save_feature', type=str,
                        default=r'/root/autodl-tmp/GGO_ISDC_public/Results/Our_wegts/Prostate/GGO_ISDC_Feature_Prostate.pth')
    paras.add_argument('--weights_save_head',  type=str,
                        default=r'/root/autodl-tmp/GGO_ISDC_public/Results/Our_wegts/Prostate/GGO_ISDC_Head_Prostate.pth')
    ...
    if args.data_parallel == False:
        ...
        GGO_ISDC_head = GGO_ISDC_Head(base_model=swinT_base, class_num=args.class_num, bags_len=args.bags_len,
                                    batch_size = args.batch_size, close_rate=0.8, model_stats=args.run_mode)
