...
def frmil_cfg(class_num = 2):
    ...
    frmil_paras.add_argument('--output_class', type=int, default=class_num)

    return frmil_paras.parse_args()


if __name__ == "__main__":
     # CAMELYON16: 2, CAMELYON16: 3, CAMELYON16: 3, CAMELYON16: 3
    random_seed = 1
    batch_size = 1
    num_classes = 2  # CAMELYON16: 2, CAMELYON16: 3, CAMELYON16: 3
    epoch = 100
    gpu_device = 1
    ...
    roc_save_path = r'/root/autodl-tmp/GGO_ISDC_public/Results/Predictions/CAMELYON16/FRMIL'
    resu_text_path = \
        r'/root/autodl-tmp/GGO_ISDC_public/Results/Our_wegts/CAMELYON16/Other_models/FRMIL_train_log.txt'
    layers_save_path = r'/root/autodl-tmp/GGO_ISDC_public/Results/Layers/CAMELYON16/FRMIL'
    feats_save_path = r'/root/autodl-tmp/GGO_ISDC_public/Results/Features/CAMELYON16/FRMIL'
