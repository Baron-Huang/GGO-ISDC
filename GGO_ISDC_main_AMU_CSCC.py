...
if __name__ == '__main__':
    ...
    paras.add_argument('--class_num', type=int, default=3)  #AMU_CSCC: 3
    ...
    paras.add_argument('--feats_save_path', type=str,
                       default=r'/root/autodl-tmp/GGO_ISDC_public/Results/Features/AMU_CSCC/GGO_ISDC')
    paras.add_argument('--layers_save_path', type=str,
                       default=r'/root/autodl-tmp/GGO_ISDC_public/Results/Layers/AMU_CSCC/GGO_ISDC')
    paras.add_argument('--relations_save_path', type=str,
                       default=r'/root/autodl-tmp/GGO_ISDC_public/Results/Relations/AMU_CSCC/GGO_ISDC')

    paras.add_argument('--roc_save_path', type=str,
                       default=r'/root/autodl-tmp/GGO_ISDC_public/Results/Predictions/AMU_CSCC')
    paras.add_argument('--roc_name', type=str, default=r'ROC_GGO_ISDC.csv')
    paras.add_argument('--train_log_path', type=str,
            default=r'/root/autodl-tmp/GGO_ISDC_public/Results/Our_wegts/AMU_CSCC/GGO_ISDC_AMU_CSCC_public_train_log.txt')

    # read datasets
    paras.add_argument('--train_read_path', type=str,
                default=r'/root/autodl-tmp/GGO_ISDC_public/Datasets/AMU_CSCC/CSCC_WSI_without_PE_public/Train')
    paras.add_argument('--test_read_path', type=str,
                default=r'/root/autodl-tmp/GGO_ISDC_public/Datasets/AMU_CSCC/CSCC_WSI_without_PE_public/Test')
    paras.add_argument('--val_read_path', type=str,
                default=r'/root/autodl-tmp/GGO_ISDC_public/Datasets/AMU_CSCC/CSCC_WSI_without_PE_public/Test')

    paras.add_argument('--weights_save_path', type=str,
        default=r'/mnt/Weights_Result_Text/GGO_ISDC/AMU_CSCC/GGO_ISDC_AMU_CSCC.pth')
    paras.add_argument('--test_weights_path', type=str,
            default=r'/root/autodl-tmp/Weights_Result_Text/GGO_ISDC/AMU_CSCC/GGO_ISDC_AMU_CSCC.pth')


    ### Parallel save
    paras.add_argument('--weights_save_feature', type=str,
                default=r'/root/autodl-tmp/GGO_ISDC_public/Results/Our_wegts/AMU_CSCC/GGO_ISDC_Feature_AMU_CSCC_public.pth')
    paras.add_argument('--weights_save_head',  type=str,
                default=r'/root/autodl-tmp/GGO_ISDC_public/Results/Our_wegts/AMU_CSCC/GGO_ISDC_Head_AMU_CSCC_public.pth')
