...
if __name__ == '__main__':
    ...
    ### single mode
    feats_full = joblib.load(r'/root/autodl-tmp/GGO_ISDC_public/Results/Features/AMU_LSCC/GGO_ISDC/feats_full.joblib')
    relations = joblib.load(r'/root/autodl-tmp/GGO_ISDC_public/Results/Relations/AMU_LSCC/GGO_ISDC/relations.joblib')
    labels = joblib.load(r'/root/autodl-tmp/GGO_ISDC_public/Results/Relations/AMU_LSCC/GGO_ISDC/labels.joblib')
    ...
    save_root_path = r'/root/autodl-tmp/GGO_ISDC_public/Results/Visual/AMU_LSCC/GGO_ISDC/Topology_map'
    if not os.path.exists(save_root_path):
        os.makedirs(save_root_path)

    save_path = os.path.join(save_root_path, 'wsi_topology_lscc_' + str(inst_i) + '.jpg')
