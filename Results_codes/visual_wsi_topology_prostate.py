...
if __name__ == '__main__':
    ...
    ### single mode
    feats_full = joblib.load(r'/root/autodl-tmp/GGO_ISDC_public/Results/Features/Prostate/GGO_ISDC/feats_full.joblib')
    relations = joblib.load(r'/root/autodl-tmp/GGO_ISDC_public/Results/Relations/Prostate/GGO_ISDC/relations.joblib')
    labels = joblib.load(r'/root/autodl-tmp/GGO_ISDC_public/Results/Relations/Prostate/GGO_ISDC/labels.joblib')
    ...
    adje_value = 0.5
    offsets = [
        (-0.2, 0.0),  # Cluster 0 标签放右上
        (-0.2, -0.05),  # Cluster 1 标签放左上
    ]
    ...
    save_root_path = r'/root/autodl-tmp/GGO_ISDC_public/Results/Visual/Prostate/GGO_ISDC/Topology_map'
    if not os.path.exists(save_root_path):
        os.makedirs(save_root_path)

    save_path = os.path.join(save_root_path, 'wsi_topology_prostate_' + str(inst_i) + '.jpg')
