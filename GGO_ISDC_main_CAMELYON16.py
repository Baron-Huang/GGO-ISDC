...
#### Attempt: Testing and Traning GGO-ISDC main function on the CAMELYON16 dataset
'''
Paper Title:
...
from Models.GGO_ISDC_model_modules import GGO_ISDC_Head, GGO_ISDC_Feature_Parallel_Public
...
if __name__ == '__main__':
    ...
    paras.add_argument('--feats_save_path', type=str,
                       default=r'/root/autodl-tmp/GGO_ISDC_public/Results/Features/CAMELYON16/GGO_ISDC')
    paras.add_argument('--layers_save_path', type=str,
                       default=r'/root/autodl-tmp/GGO_ISDC_public/Results/Layers/CAMELYON16/GGO_ISDC')
    paras.add_argument('--relations_save_path', type=str,
                       default=r'/root/autodl-tmp/GGO_ISDC_public/Results/Relations/CAMELYON16/GGO_ISDC')

    paras.add_argument('--roc_save_path', type=str,
                       default=r'/root/autodl-tmp/GGO_ISDC_public/Results/Predictions/CAMELYON16')
    paras.add_argument('--roc_name', type=str, default=r'ROC_GGO_ISDC.csv')
    paras.add_argument('--train_log_path', type=str,
                       default=r'/root/autodl-tmp/GGO_ISDC_public/Results/Our_wegts/CAMELYON16/GGO_ISDC_CAMELYON16_train_log.txt')

    # read datasets
    paras.add_argument('--train_read_path', type=str,
                default=r'/root/autodl-tmp/GGO_ISDC_public/Datasets/CAMELYON16/CAMELYON_WSI_without_PE/Train')
    paras.add_argument('--test_read_path', type=str,
                default=r'/root/autodl-tmp/GGO_ISDC_public/Datasets/CAMELYON16/CAMELYON_WSI_without_PE/Test')
    paras.add_argument('--val_read_path', type=str,
                default=r'/root/autodl-tmp/GGO_ISDC_public/Datasets/CAMELYON16/CAMELYON_WSI_without_PE/Test')

    paras.add_argument('--weights_save_path', type=str,
        default=r'/mnt/Weights_Result_Text/GGO_ISDC/CAMELYON16/GGO_ISDC_CAMELYON16.pth')
    paras.add_argument('--test_weights_path', type=str,
            default=r'/root/autodl-tmp/Weights_Result_Text/GGO_ISDC/CAMELYON16/GGO_ISDC_CAMELYON16.pth')


    ### Parallel save
    paras.add_argument('--weights_save_feature', type=str,
                        default=r'/root/autodl-tmp/GGO_ISDC_public/Results/Our_wegts/CAMELYON16/GGO_ISDC_Feature_CAMELYON16.pth')
    paras.add_argument('--weights_save_head',  type=str,
                        default=r'/root/autodl-tmp/GGO_ISDC_public/Results/Our_wegts/CAMELYON16/GGO_ISDC_Head_CAMELYON16.pth')
    ...
    if args.data_parallel == False:
        ...
        GGO_ISDC_head = GGO_ISDC_Head(base_model=swinT_base, class_num=args.class_num, bags_len=args.bags_len,
                                    ...
                                    growth_vulue=1.1, close_rate=0.5, model_stats=args.run_mode)
