...
def other_paras_cfg():
    ...
    paras.add_argument('--pretrained_weights_path', type=str,
                        default='/root/autodl-tmp/Weights/SwinT/swin_tiny_patch4_window7_224_22k.pth')
...
if __name__ == '__main__':
    new_tensor = extract_features_for_swint(base_args=base_paras_cfg(), other_args=other_paras_cfg(),
            save_path='/root/autodl-tmp/GGO_ISDC_public/Datasets/CAMELYON16/New_pretrained/Test', gpu_device = 1,
            read_path=r'/root/autodl-tmp/GGO_ISDC_public/Datasets/CAMELYON16/CAMELYON_WSI_without_PE/Test')
